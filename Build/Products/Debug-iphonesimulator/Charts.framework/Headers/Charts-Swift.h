...
@property (nonatomic, copy) NSArray<id <IChartDataSet>> * __null_unspecified _dataSets;
...
- (void)initialize:(NSArray<id <IChartDataSet>> * __nonnull)dataSets;
- (void)calcXValAverageLength;
- (void)checkIsLegal:(NSArray<id <IChartDataSet>> * __null_unspecified)dataSets;
...
- (NSInteger)getDataSetIndexByLabel:(NSString * __nonnull)label ignorecase:(BOOL)ignorecase;
...
- (NSArray<NSString *> * __nonnull)dataSetLabels;
...
///
/// <em>optional feature, can return false or throw</em>
///
...
/// the formatter used to customly format the values
@property (nonatomic, strong) NSNumberFormatter * __nullable _valueFormatter;
...
@property (nonatomic, copy) NSArray<ChartDataEntry *> * __null_unspecified _yVals;
@property (nonatomic) double _yMax;
@property (nonatomic) double _yMin;
...
@property (nonatomic, strong) NSNumberFormatter * __nonnull _defaultValueFormatter;

/// object that holds all data that was originally set for the chart, before it was modified or any filtering algorithms had been applied
@property (nonatomic, strong) ChartData * __null_unspecified _data;
...
@property (nonatomic) CGFloat _deltaX;
@property (nonatomic) double _chartXMin;
@property (nonatomic) double _chartXMax;

/// the legend object containing all data associated with the legend
@property (nonatomic, strong) ChartLegend * __null_unspecified _legend;
...
@property (nonatomic, strong) ChartLegendRenderer * __null_unspecified _legendRenderer;
...
@property (nonatomic, strong) ChartViewPortHandler * __null_unspecified _viewPortHandler;

/// object responsible for animations
@property (nonatomic, strong) ChartAnimator * __null_unspecified _animator;

/// array of Highlight objects that reference the highlighted slices in the chart
@property (nonatomic, copy) NSArray<ChartHighlight *> * __nonnull _indicesToHighlight;
...
- (void)drawDescriptionWithContext:(CGContextRef __nonnull)context;
...
- (void)drawMarkersWithContext:(CGContextRef __nonnull)context;
...
@property (nonatomic, strong) ChartYAxis * __null_unspecified _leftAxis;
@property (nonatomic, strong) ChartYAxis * __null_unspecified _rightAxis;

/// the object representing the labels on the x-axis
@property (nonatomic, strong) ChartXAxis * __null_unspecified _xAxis;
@property (nonatomic, strong) ChartYAxisRenderer * __null_unspecified _leftYAxisRenderer;
@property (nonatomic, strong) ChartYAxisRenderer * __null_unspecified _rightYAxisRenderer;
@property (nonatomic, strong) ChartTransformer * __null_unspecified _leftAxisTransformer;
@property (nonatomic, strong) ChartTransformer * __null_unspecified _rightAxisTransformer;
@property (nonatomic, strong) ChartXAxisRenderer * __null_unspecified _xAxisRenderer;
@property (nonatomic, strong) UITapGestureRecognizer * __null_unspecified _tapGestureRecognizer;
@property (nonatomic, strong) UITapGestureRecognizer * __null_unspecified _doubleTapGestureRecognizer;
@property (nonatomic, strong) UIPinchGestureRecognizer * __null_unspecified _pinchGestureRecognizer;
@property (nonatomic, strong) UIPanGestureRecognizer * __null_unspecified _panGestureRecognizer;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)initialize;
- (void)drawRect:(CGRect)rect;
...
- (void)drawGridBackgroundWithContext:(CGContextRef __nonnull)context;
...
SWIFT_CLASS("_TtC6Charts25BarLineChartFillFormatter")
@interface BarLineChartFillFormatter : NSObject <ChartFillFormatter>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (CGFloat)getFillLinePositionWithDataSet:(id <ILineChartDataSet> __nonnull)dataSet dataProvider:(id <LineChartDataProvider> __nonnull)dataProvider;
@end
...
@property (nonatomic, strong) ChartViewPortHandler * __nonnull _viewPortHandler;
- (nonnull instancetype)initWithViewPortHandler:(ChartViewPortHandler * __nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
...
- (void)drawYLabelsWithContext:(CGContextRef __nonnull)context fixedPosition:(CGFloat)fixedPosition offset:(CGFloat)offset textAlign:(NSTextAlignment)textAlign;
- (void)renderGridLinesWithContext:(CGContextRef __nonnull)context;
- (void)renderLimitLinesWithContext:(CGContextRef __nonnull)context;
@end
...
@property (nonatomic) BOOL drawBarShadowEnabled;
@property (nonatomic, copy) NSArray<ChartDataRendererBase *> * __nonnull _renderers;
...
@property (nonatomic, strong) id <ChartFillFormatter> __null_unspecified _fillFormatter;
- (void)initialize;
- (void)calcMinMax;
@property (nonatomic, strong) ChartData * __nullable data;
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithXVals:(NSArray<NSObject *> * __nullable)xVals dataSets:(NSArray<id <IChartDataSet>> * __nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, strong) PieChartDataSet * __nullable dataSet;
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithYVals:(NSArray<ChartDataEntry *> * __nullable)yVals label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic) double _yValueSum;
@property (nonatomic, readonly) double yValueSum;
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(id <IRadarChartDataSet> __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
...
@property (nonatomic, strong) ChartYAxisRendererRadarChart * __null_unspecified _yAxisRenderer;
@property (nonatomic, strong) ChartXAxisRendererRadarChart * __null_unspecified _xAxisRenderer;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)initialize;
- (void)calcMinMax;
...
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results xValueField:(NSString * __nonnull)xValueField dataSets:(NSArray<id <IChartDataSet>> * __nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithLabel:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField label:(NSString * __nullable)label;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere yValueField:(NSString * __nonnull)yValueField label:(NSString * __nullable)label;
- (void)loadResultsWithRealm:(RLMRealm * __nonnull)realm modelName:(NSString * __nonnull)modelName;
- (void)loadResultsWithRealm:(RLMRealm * __nonnull)realm modelName:(NSString * __nonnull)modelName predicate:(NSPredicate * __nullable)predicate;
@property (nonatomic, strong) RLMResults * __nullable _results;
@property (nonatomic, copy) NSString * __nullable _yValueField;
@property (nonatomic, copy) NSString * __nullable _xIndexField;
@property (nonatomic, copy) NSArray<ChartDataEntry *> * __nonnull _cache;
@property (nonatomic) NSInteger _cacheFirst;
@property (nonatomic) NSInteger _cacheLast;
@property (nonatomic) double _yMax;
@property (nonatomic) double _yMin;
...
- (void)ensureCacheWithStart:(NSInteger)start end:(NSInteger)end;
- (ChartDataEntry * __nonnull)buildEntryFromResultObject:(RLMObject * __nonnull)object atIndex:(NSUInteger)atIndex;
...
@property (nonatomic, readonly, copy) NSString * __nullable yValueField;

/// Returns the fieldname that represents the "x-index" in the realm-data.
@property (nonatomic, readonly, copy) NSString * __nullable xIndexField;
- (id __nonnull)copyWithZone:(NSZone * __null_unspecified)zone;
@end
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField stackValueField:(NSString * __nonnull)stackValueField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField stackValueField:(NSString * __nonnull)stackValueField;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField stackValueField:(NSString * __nonnull)stackValueField label:(NSString * __nonnull)label;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField stackValueField:(NSString * __nonnull)stackValueField;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField stackValueField:(NSString * __nonnull)stackValueField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nullable)xIndexField stackValueField:(NSString * __nonnull)stackValueField;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere yValueField:(NSString * __nonnull)yValueField stackValueField:(NSString * __nonnull)stackValueField label:(NSString * __nullable)label;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere yValueField:(NSString * __nonnull)yValueField stackValueField:(NSString * __nonnull)stackValueField;
- (void)notifyDataSetChanged;
@property (nonatomic, copy) NSString * __nullable _stackValueField;
- (ChartDataEntry * __nonnull)buildEntryFromResultObject:(RLMObject * __nonnull)object atIndex:(NSUInteger)atIndex;
- (void)calcMinMaxWithStart:(NSInteger)start end:(NSInteger)end;
...
- (void)initialize;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nonnull)xIndexField sizeField:(NSString * __nonnull)sizeField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nonnull)xIndexField sizeField:(NSString * __nonnull)sizeField;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere yValueField:(NSString * __nonnull)yValueField xIndexField:(NSString * __nonnull)xIndexField sizeField:(NSString * __nonnull)sizeField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, copy) NSString * __nullable _sizeField;
@property (nonatomic) double _xMax;
@property (nonatomic) double _xMin;
@property (nonatomic) CGFloat _maxSize;
@property (nonatomic, readonly) double xMin;
...
- (void)initialize;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results highField:(NSString * __nonnull)highField lowField:(NSString * __nonnull)lowField openField:(NSString * __nonnull)openField closeField:(NSString * __nonnull)closeField xIndexField:(NSString * __nonnull)xIndexField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * __nullable)results highField:(NSString * __nonnull)highField lowField:(NSString * __nonnull)lowField openField:(NSString * __nonnull)openField closeField:(NSString * __nonnull)closeField xIndexField:(NSString * __nonnull)xIndexField;
- (nonnull instancetype)initWithRealm:(RLMRealm * __nullable)realm modelName:(NSString * __nonnull)modelName resultsWhere:(NSString * __nonnull)resultsWhere highField:(NSString * __nonnull)highField lowField:(NSString * __nonnull)lowField openField:(NSString * __nonnull)openField closeField:(NSString * __nonnull)closeField xIndexField:(NSString * __nonnull)xIndexField label:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, copy) NSString * __nullable _highField;
@property (nonatomic, copy) NSString * __nullable _lowField;
@property (nonatomic, copy) NSString * __nullable _openField;
@property (nonatomic, copy) NSString * __nullable _closeField;
- (ChartDataEntry * __nonnull)buildEntryFromResultObject:(RLMObject * __nonnull)object atIndex:(NSUInteger)atIndex;
- (void)calcMinMaxWithStart:(NSInteger)start end:(NSInteger)end;
...
+ (NSArray<NSString *> * __nonnull)toXValsWithResults:(RLMResults * __nonnull)results xValueField:(NSString * __nonnull)xValueField;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
